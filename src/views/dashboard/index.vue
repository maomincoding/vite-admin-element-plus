<template>
  <div class="app-container dashboard">
    <ul class="dashboard-top">
      <li class="card-box">
        <div class="top-tit text">能耗总数</div>
        <div class="num-move-box">
          <NumMove :number="'002003'" :bgc="'#4091c9'" />
        </div>
      </li>
      <li class="card-box">
        <div class="top-tit">当月能耗</div>
        <div class="num-move-box">
    ...
    <div class="dashboard-footer">
      ...
      <div class="card-box">
        <div class="dashboard-footerChart-tit">
          <p class="top-tit">能耗统计</p>
        </div>
        <div class="dashboard-footer-item2"></div>
      </div>
      <div class="card-box">
        <div class="dashboard-footerChart-tit">
          <p class="top-tit">能耗分析</p>
    ...
    <Dialogbox v-model:status="rankingEnergyBoxView" :width="'40%'">
      <template v-slot:header>
        <p style="text-align: center">能耗占比排行</p>
      </template>
    ...
    <Dialogbox v-model:status="pueTrendView" :width="'40%'">
      <template v-slot:header>
        <p style="text-align: center">能耗PUE曲线图</p>
      </template>
      <template v-slot:default>
